...
import {
  LayoutDashboard, User, Stethoscope, ChevronLeft, ChevronRight,
  Settings, Heart, Pill
} from 'lucide-react';
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-700">
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <p className="text-sm font-bold text-white leading-tight">Clinic Portal</p>
            <p className="text-xs text-gray-400">Health System</p>
          </div>
        )}
      </div>
