class AppConstants {
  ...
  static const String appDescription = 'AI-powered disease diagnosis for rural clinics';
  
  // API Configuration
  static const String baseUrl = 'https://api.ruralclinic.health';
  ...
  static const Map<String, Map<String, double>> vitalRanges = {
    'temperature': {'min': 35.0, 'max': 42.0, 'normal_min': 36.1, 'normal_max': 37.2},
    'blood_pressure_systolic': {'min': 70, 'max': 200, 'normal_min': 90, 'normal_max': 120},
    'blood_pressure_diastolic': {'min': 40, 'max': 120, 'normal_min': 60, 'normal_max': 80},
